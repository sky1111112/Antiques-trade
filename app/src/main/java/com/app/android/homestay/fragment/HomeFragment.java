...
import com.app.android.homestay.TimeChoose;
...
//                        //Intent intent= new Intent(getActivity(), TimeChoosing.class);
...
//                builder.show();
                HouseInfo houseInfo = mHomeAdapter.getData().get(position);
                    Intent intent= new Intent(getActivity(),TimeChoose.class);

                Bundle bundle =new Bundle();
                bundle.putString("username",Config.getUserInfo().getUsername());
                bundle.putString("introduce",houseInfo.getIntroduce());
                bundle.putString("original_price",houseInfo.getOriginal_price());
                bundle.putString("discount_price", houseInfo.getDiscount_price());
                bundle.putString("address", houseInfo.getAddress());
                bundle.putString("house_img",houseInfo.getHouse_img());
