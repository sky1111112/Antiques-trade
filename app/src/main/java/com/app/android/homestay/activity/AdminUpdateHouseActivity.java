...
public class AdminUpdateHouseActivity extends BaseActivity {
        ...
        findViewById(R.id.update).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(introduceStr)) {
                    ...
                    if (mHouseInfo != null) {
                        update(mHouseInfo.getHouse_id(), introduceStr, originalprice, discountprice, addressStr, compressPath);
                    }
    ...
    private void update(int house_id, String introduceStr, String originalprice, String discountprice, String addressStr, String compressPath) {

        PostRequest<String> post = OkGo.<String>post(Config.HOUSE_UPDATE_URL);
        post.params("house_id", house_id);
