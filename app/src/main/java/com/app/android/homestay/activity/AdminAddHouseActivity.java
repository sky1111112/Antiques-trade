...
public class AdminAddHouseActivity extends BaseActivity {
        ...
        findViewById(R.id.push).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(introduceStr)) {
                    ...
                    push(introduceStr, originalprice, discountprice, addressStr, compressPath,username);
                }
            }
        });
    ...
    private void push(String introduceStr, String originalprice, String discountprice, String addressStr, String compressPath,String username) {
